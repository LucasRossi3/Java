...
public class Aplic {
    public static void main(String[] args) {
       ...
       Projeto objProjeto = new Projeto(1, "Sistema de Vendas");
       objProjeto.addFuncionarios(funcCom);
       objProjeto.addFuncionarios(funcHor);
       objProjeto.addFuncionarios(funcMen);
       objProjeto.listarFuncionarios();
    }    
}
